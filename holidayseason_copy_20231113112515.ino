/*
  Author: Edward Phiri
  Date: 2023-11-03
  Purpose: C++ program for the Holiday season that plays a sound with LED's and display char on the LCD.
  TME: Tech Master Event 
...
void loop() {
  ...
  void screen(){
      ...
      lcd.print("Merry Christmas & Happy New Year ");
      lcd.setCursor(4,1);
      lcd.print("From Tech Master Event (TME)");
  }